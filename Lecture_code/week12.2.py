...
json.dump(mario, open("/workspaces/data_3500_in_class_code/Lecture_code/mario.json", "w"), indent=4)

mario_dict = json.load(open("/workspaces/data_3500_in_class_code/Lecture_code/mario.json"))
#print(mario_dict)
